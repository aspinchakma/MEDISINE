            ...
            <Navbar bg="white" expand="lg">
                <Container>
                    ...
                    <Navbar.Collapse id="navbarScroll">
                        ...
                        {
                            user.email === undefined && <NavLink to="/signUp"><button className="common-button me-2">Sign Up</button></NavLink>
                        }
                        {
                            user.email === undefined && <NavLink to="/signIn"><button className="common-button">Sign In</button></NavLink>
                        }
                        {
                            user.email && <button onClick={logOut} className="common-button">Log out</button>
                        }
